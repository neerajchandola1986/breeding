                    ...
                    <form role="form" action="<?php echo base_url() ?>user/editprofile" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputPassword1">Existing Email</label>
                                        <input type="text" class="form-control" id="email" value="<?php echo $getmobile['email']; ?>" name="email" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputPassword1">Existing Phone</label>
                                        <input type="text" class="form-control" id="phone" value="<?php echo $getmobile['mobile']; ?>" name="phone" required>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
